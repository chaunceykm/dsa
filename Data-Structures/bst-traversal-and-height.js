...
class BST {
  ...
  //returns boolean whether or not the minHeight and maxHeight are not greater than 1
  isBalanced() {
    return this.findMinHeight() >= this.findMaxHeight() - 1;
  }
  //distance from root to first node without two children
  ...
  //distance from root to the bottom most node
  ...
  inOrder() {
    if (this.root == null) {
      ...
      function traverseInOrder(node) {
        ...
        node.right && traverseInOrder(ode.right);
      }
